...
namespace Management\Service\Factory;
...
/**
 * Description of ManagementManagerFactory
 *
 * @author Elder Mutzus <elder.mutzus@inspireswgt.com>
 */
class ManagementManagerFactory implements FactoryInterface
{
    /**
    ...
    {        
        ...
        return new ManagementManager($sessionContainer, $config, $entityManager);
    }
}
