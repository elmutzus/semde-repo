...
/**
 * Description of StudentParentControllerHelper
 *
 * @author Elder Mutzus <elmutzus@gmail.com>
 */
class StudentParentControllerHelper
{
    /**
     *
     * @var type 
    ...
    public function fillFormData($form, $existingData, $studentId)
    {
        ...
        $form->get('parentType')->setValue($existingData->getParentType());
        $form->get('lives')->setValue($existingData->getLives());
